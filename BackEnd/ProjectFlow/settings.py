...
# Default capacity units for PynamoDB GSIs (used in models.py)
DYNAMODB_DEFAULT_READ_CAPACITY = int(os.getenv('DYNAMODB_READ_CAPACITY', '5'))
DYNAMODB_DEFAULT_WRITE_CAPACITY = int(os.getenv('DYNAMODB_WRITE_CAPACITY', '5'))
